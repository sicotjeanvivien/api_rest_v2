use crate::{HttpError, HttpMethod, HttpRequest};
...
pub async fn decode_request<R>(stream: &mut R) -> Result<HttpRequest, HttpError>
where
    R: AsyncRead + Unpin,
{
...
mod tests {
    ...
    use crate::{HttpError, HttpMethod, decode_request};
